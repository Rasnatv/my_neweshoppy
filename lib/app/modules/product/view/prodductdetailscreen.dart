...
class ProductDetailPage extends StatelessWidget {
      ...
      body: Obx(() {
        ...
        return Stack(
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(
                      height: 32, thickness: 8, color: Color(0xFFF0F0F0)),
            ...
            _buildBottomBar(product, variant),
          ],
        );
      }),
    );
  ...
  Widget _buildBottomBar(ProductDetailModel product, ProductVariantModel variant) {
    final stockCount = int.parse(variant.stock);
    final isOutOfStock = stockCount == 0;
