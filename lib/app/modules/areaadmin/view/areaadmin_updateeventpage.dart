...
class AreaAdminUpdateEventPage extends StatelessWidget {
  ...
  static const _slate500 = Color(0xFF64748B);
  static const _slate200 = Color(0xFFE2E8F0);
  static const _slate100 = Color(0xFFF1F5F9); // locked field bg
            ...
            children: [
              ...
              Obx(() {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color       : _slate100, // greyed-out bg signals non-editable
                    borderRadius: BorderRadius.circular(12),
                    border      : Border.all(color: _slate200, width: 1.5),
                  ),
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          controller.selectedMainLocation.value?.isNotEmpty == true
