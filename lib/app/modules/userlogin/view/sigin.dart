...
//   static const primaryDeep  = Color(0xFF005F52);
...
//     BoxShadow(
//       color: primaryDark.withOpacity(0.28),
//       blurRadius: 20,
//       offset: const Offset(0, 8),
//       spreadRadius: -4,
//     ),
...
//             decoration: BoxDecoration(
//               shape: BoxShape.circle,
//               color: _T.primaryDark.withOpacity(0.06),
//             ),
//           ),
//         ),
//         // Subtle grid texture
...
//           colors: [Color(0xFF1DE9D0), Color(0xFF00897B)],
//         ),
//         boxShadow: _T.primaryShadow,
//       ),
//       child: ClipRRect(
//         borderRadius: BorderRadius.circular(28),
//         child: Stack(
...
//                 boxShadow: [
//                   BoxShadow(
//                     color: _T.primaryDark.withOpacity(0.22),
//                     blurRadius: 10,
...
class _T {
  // Brand
  static const primary     = Color(0xFF1A56DB); // professional blue
  static const primaryDark = Color(0xFF1341AA);
  static const accent      = Color(0xFF0E9F6E); // success/CTA green
  ...
  static const ink900 = Color(0xFF111827); // headings
  static const ink700 = Color(0xFF374151); // body
  static const ink400 = Color(0xFF9CA3AF); // muted
...
class _LoginScreenState extends State<LoginScreen>
  ...
  static const _count  = 5;
  static const _delays = [0.00, 0.10, 0.22, 0.34, 0.50];
  static const _ends   = [0.28, 0.38, 0.50, 0.66, 0.84];
  ...
  void initState() {
    ...
    _slides = List.generate(_count, (i) {
      final offsets = [
        const Offset(0, -0.20), // logo
        const Offset(0,  0.20), // title
        const Offset(0,  0.20), // role
        const Offset(0,  0.20), // card
        const Offset(0,  0.16), // bottom
      ];
      return Tween<Offset>(begin: offsets[i], end: Offset.zero).animate(
        CurvedAnimation(
          parent: _enter,
            ...
            child: Center(
              child: SingleChildScrollView(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    _reveal(0, _buildBrandHeader()),
                    const SizedBox(height: 36),
                    _reveal(1, _buildWelcomeText()),
                    const SizedBox(height: 28),
                    _reveal(2, _buildRoleSelector()),
  ...
  Widget _buildBackground() {
    return Stack(
      children: [
        ...
        // Thin brand top border
        Positioned(
          top: 0, left: 0, right: 0,
          child: Container(height: 3, color: _T.primary),
        ),
      ],
    );
  }
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              fontWeight: isSelected
                                  ? FontWeight.w600
                                  : FontWeight.w500,
                              color: isSelected ? Colors.white : _T.ink700,
                            ),
                          ),
                        ],
                      ),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: _T.surface,
            borderRadius: BorderRadius.circular(10),
            border: Border.all(color: _T.primary.withOpacity(0.30), width: 1),
            boxShadow: _T.cardShadow,
          ),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
