...
//                                         borderRadius: BorderRadius.circular(8),
//                                         onTap: () async {
//                                           // Navigate to product detail page with all product data
//                                           if (product.id != null) {
//                                             final result = await Get.to(
//                                                   () => ProductDetailUpdatePage(
//                                                 productId: product.id!,
//                                                 productName: product.name,
//                                                 description: null, // We don't have description in list API
//                                                 commonAttributes: null, // We don't have common attributes in list API
...
//                                             );
//
//                                             // Refresh products if update was successful
//                                             if (result == true) {
...
import 'merchnatproductediting.dart'; // ✅ Import UpdateProductPage
