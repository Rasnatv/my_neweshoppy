                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // ── Price & Stock — separated with accent chips ──
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Price field with green accent bar
                          Container(
                            decoration: BoxDecoration(
                              border: Border(
                                left: BorderSide(
                          ...
                          // Stock field with primary accent bar
                          Container(
                            decoration: BoxDecoration(
                              border: Border(
                                left: BorderSide(
                      ...
                      Obx(() {
                        ...
                        controller.priceTickForVariant(index); // only THIS variant's tick
    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(
            color: focusedBorderColor ?? _primary, width: 1.5),
      ),
      contentPadding:
