                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      // Variant attributes
                      Obx(() => Column(
                        children: form.attrCtrls.entries
                            .map<Widget>((entry) {
                          return Padding(
...
class _PriceStockRow extends StatelessWidget {
  final VariantForm form;
  const _PriceStockRow({required this.form});
...
class _PriceStockChip extends StatelessWidget {
