  ...
  Widget build(BuildContext context) {
    return NetworkAwareWrapper(
      child: Scaffold(
        ...
        // ── Wrap entire body in a Form so validators fire ──────────────────
        body: Form(
          key: _formKey,
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: inputStyle(
                            "Owner Name *", Icons.person_outline),
                      ...
                      TextFormField(
                        ...
                        style: const TextStyle(color: Color(0xFF1A1A1A)),
                        decoration: inputStyle(
                            "Shop Name *", Icons.storefront_outlined),
                        textInputAction: TextInputAction.next,
                        validator: (v) {
                          if (v == null || v.trim().isEmpty) {
                      ...
                      // Phone No 1 — digits only, numeric keyboard
                      TextFormField(
                        controller: controller.phoneNo1Controller,
                        style: const TextStyle(color: Color(0xFF1A1A1A)),
                        decoration: inputStyle(
                            "Phone Number *", Icons.phone_outlined),
                        // ── FIX: number pad keyboard (no alpha keys) ──
                        keyboardType: TextInputType.number,
                        // ── FIX: strip any non-digit character & limit to 10 ──
                        inputFormatters: [
                      ...
                      // Phone No 2 — digits only, numeric keyboard
                      TextFormField(
                        ...
                        validator: (v) {
                          // Optional — validate only if something is entered
                          if (v != null &&
                              v.trim().isNotEmpty &&
                              v.trim().length != 10) {
                    ...
                    children: [
                      ...
                      Obx(() {
                        ...
                        return DropdownButtonFormField(
                          ...
                          decoration:
                          inputStyle("State *", Icons.flag_outlined),
                      ...
                      Obx(() {
                        ...
                        return DropdownButtonFormField(
                          value: controller.selectedLocation.value.isEmpty
                              ...
                              : controller.selectedLocation.value,
                          decoration: inputStyle(
                              "Main Location *", Icons.place_outlined),
                          dropdownColor: Colors.white,
                          style:
                          const TextStyle(color: Color(0xFF1A1A1A)),
                          ...
                          validator: (v) {
                            if (controller.selectedDistrict.value
                                .isNotEmpty &&
                                (v == null || v.isEmpty)) {
                              return 'Please select main location';
                            }
                            return null;
                          },
                        );
                ...
                _sectionHeader("Optional Information",
                ...
                Obx(() => Container(
                  ...
                  child: ElevatedButton(
                    onPressed: controller.isLoading.value
                        ? null
                        : () {
                      // ── FIX: trigger form validators first ──
