...
class DistrictAdminAddEventPage extends StatelessWidget {
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                items: controller.states
                    ...
                    .toList(),
                // ✅ calls onStateChanged — fetches districts for selected state
                onChanged: controller.isStatesLoading.value
                    ? null
                    : (value) {
                  if (value != null) controller.onStateChanged(value);
                },
              ),
            ),
          ),
  ...
  Widget _districtDropdown() {
    return Obx(() {
      ...
      // Show placeholder when no state selected yet
      final bool noStateSelected = controller.selectedState.value.isEmpty;
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                items: controller.districts
                    ...
                    .toList(),
                // Disabled until a state is chosen and districts are loaded
