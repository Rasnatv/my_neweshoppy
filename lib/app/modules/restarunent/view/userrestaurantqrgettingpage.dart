...
//     'upi://pay'
//         '?pa=${item.upiId.trim()}'
//         '&pn=${Uri.encodeComponent(item.restaurantName.trim())}'
//         '&am=${item.totalPrice.toStringAsFixed(2)}'
//         '&cu=INR',
//   );
//
...
//     );
//   } catch (e) {
//     _snack('Error', 'Could not open UPI app');
//     return;
//   }
//
...
//
//   // Get the already-registered controller
...
//
//                       // ✅ Call storeTransaction from controller
//                       for (final item in data) {
//                         final success =
