            ...
            children: [
                    ...
                    Obx(() => Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                            AppColors.restaurantclr.withOpacity(0.1),
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(
                              color: AppColors.restaurantclr
                                  .withOpacity(0.3),
              ...
              Obx(() => Column(
                children: List.generate(
                  controller.bookingRows.length,
                      (i) =>
                      _MealCard(index: i, controller: controller),
                ),
              )),
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            onPressed: controller.isSaving.value
              ...
              // ── Show success sheet then navigate to cart ───────
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Get.back(); // close sheet
                Get.offAll(() => RestaurantMainCart(restaurantId: restaurantId));
              },
              child: const Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
...
// ─────────────────────────────────────────────────────────────────────────────
// TABLES — horizontal scrollable chips
// ─────────────────────────────────────────────────────────────────────────────
class _TablesWidget extends StatelessWidget {
  final int index;
  final RestaurantBookingController controller;
