...
//                           border: Border.all(
//                             color:
//                             AppColors.restaurantclr.withOpacity(0.35),
//                             width: 1.4,
//                           ),
//                           boxShadow: [
//                             BoxShadow(
...
//               if (summary == null) {
//                 AppSnackbar.error("Please complete at least one meal (seating type, time slot and table).");
//                 return;
//               }
//
...
//               }
//
//               // ✅ Refresh cart from server immediately after save
//               if (Get.isRegistered<Restaurantcartcontroller>()) {
//                 await Get.find<Restaurantcartcontroller>().fetchCart();
//               }
//
...
//               ),
//               onPressed: () {
//                 // ✅ Close sheet first, then navigate — cart is already refreshed
//                 Get.back();
...
//                       _mealIcon(mealType),
//                       color:
//                       isComplete ? Colors.teal : AppColors.restaurantclr,
//                       size: 18,
//                     ),
//                   ),
...
//                       : Row(
//                     children: controller.availableSeatingTypes.map((type) {
...
//                   const SizedBox(height: 8),
//                   _TimeSlotsWidget(index: index, controller: controller),
//
//                   const SizedBox(height: 16),
//
//                   _FieldLabel("Table"),
                        ...
                        return Row(
                          children: [
                            ...
                            _CounterButton(
                              ...
                              enabled: !atMin,
                              onTap: () {
                                if (!atMin) controller.guests.value--;
                              },
                            ),
                            const SizedBox(width: 16),
                            // ── COUNT ────────────────────────────────
                            ...
                            _CounterButton(
                              ...
                              enabled: !atMax,
                              onTap: () {
                                if (!atMax) controller.guests.value++;
                              },
                            ),
                            // ── LOADING SPINNER ───────────────────────
                            Obx(() =>
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: controller.isSaving.value
                ...
                final cartRegistered = Get.isRegistered<Restaurantcartcontroller>();
                if (cartRegistered) {
                  await Get.find<Restaurantcartcontroller>().fetchCart();
                }
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            ...
            textAlign: TextAlign.center,
            style:
            TextStyle(fontSize: 13, color: Colors.grey, height: 1.6),
          ),
...
// ─────────────────────────────────────────────────────────────────────────────
// COUNTER BUTTON  ← updated with enabled/disabled state
// ─────────────────────────────────────────────────────────────────────────────
class _CounterButton extends StatelessWidget {
  final IconData icon;
  final VoidCallback onTap;
