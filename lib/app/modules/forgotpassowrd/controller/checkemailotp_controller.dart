    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (status == 1 || status == "1") {
          ...
          // ✅ Read message directly — bypass ApiErrorHandler completely
          final msg = data["message"]?.toString();
          AppSnackbar.error(msg?.isNotEmpty == true ? msg! : "Invalid OTP");
        }
      } else {
        // ✅ Same here — read body directly, no ApiErrorHandler
        final msg = data["message"]?.toString();
        AppSnackbar.error(msg?.isNotEmpty == true ? msg! : "Invalid OTP");
      }
