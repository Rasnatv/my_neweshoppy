...
class ProductAttributes {
  ...
  factory ProductAttributes.fromJson(Map<String, dynamic> json) {
    return ProductAttributes(
      commonAttributes: (json['common_attributes'] is Map)
          ? Map<String, dynamic>.from(json['common_attributes'] as Map)
          : {},
...
class AdminSingleOfferProductModel {
  ...
  int get totalStock =>
      productAttributes?.variants.fold(0, (sum, v) => sum! + v.stock) ?? 0;
  ...
  factory AdminSingleOfferProductModel.fromJson(Map<String, dynamic> json) {
    ...
    try {
      if (json['product_attributes'] != null) {
        attrs = ProductAttributes.fromJson(
